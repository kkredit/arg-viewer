...
const { choosePort, prepareUrls, prepareProxy } = require('react-dev-utils/WebpackDevServerUtils');
...
function printInstructions(appName, urls) {
  ...
  console.log(`To create a production build, use ` + `${chalk.cyan('elm-app build')}.`);
  console.log();
}
